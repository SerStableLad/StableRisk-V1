...
import { HandlerRegistry } from '../processors/handlers/base-handler';
import { logger } from '../utils/logger';
import { configManager } from '../config';

// Import all handlers
import { StablecoinDataCollector } from '../processors/handlers/stablecoin-data-collector';
import { TransparencyAnalyzer } from '../processors/handlers/transparency-analyzer';
import { CacheInvalidator } from '../processors/handlers/cache-invalidator';
import { MetricsAggregator } from '../processors/handlers/metrics-aggregator';
...
export class BackgroundJobsServer {
  ...
  private setupMiddleware(): void {
    ...
    this.app.use((req: Request, res: Response, next: NextFunction) => {
      ...
      res.on('finish', () => {
        ...
        logger.httpRequest(req.method, req.originalUrl, res.statusCode, duration, {
          correlationId,
          metadata: {
