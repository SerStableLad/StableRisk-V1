...
// TTL Calculator interface from the task specification
...
export class TTLCalculator {
  ...
  // Getters for testing
  public getBaseTTL(): number {
    return this.baseTTL;
  }

  public getMinTTL(): number {
    return this.minTTL;
  }
  ...
  // Setters for testing
  public setBaseTTL(ttl: number): void {
    this.baseTTL = ttl;
  }

  public setMinTTL(ttl: number): void {
    this.minTTL = ttl;
  }

  public setMaxTTL(ttl: number): void {
    this.maxTTL = ttl;
  }
}
...
describe('TTL Calculator', () => {
  ...
  describe('Access Pattern-based TTL Calculation', () => {
    ...
    test('should handle recency factor correctly', () => {
      const recentAccess: AccessPattern = {
        frequency: 10,
        recency: 0, // Just accessed
        volatility: 0.5,
        dataSize: 1000,
    ...
    test('should handle volatility factor correctly', () => {
      const stableData: AccessPattern = {
        frequency: 10,
        recency: 1,
      ...
      const volatileData: AccessPattern = {
        frequency: 10,
        recency: 1,
    ...
    test('should handle importance factor correctly', () => {
      const importantData: AccessPattern = {
        frequency: 10,
        recency: 1,
        volatility: 0.5,
        dataSize: 1000,
      ...
      const unimportantData: AccessPattern = {
        frequency: 10,
        recency: 1,
        volatility: 0.5,
        dataSize: 1000,
  ...
  describe('Configuration and Bounds', () => {
    ...
    test('should enforce bounds even with extreme access patterns', () => {
      const extremePattern: AccessPattern = {
  ...
  describe('Edge Cases', () => {
    ...
    test('should handle undefined and null values', () => {
      ...
      const result2 = ttlCalculator.calculateOptimalTTL('test:null', 1000, null as any);
