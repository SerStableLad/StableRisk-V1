...
describe('CacheServiceClient', () => {
  ...
  describe('Configuration Validation', () => {
    ...
    it('should use default configuration when env vars are not set', () => {
      ...
      if (originalUrl) process.env.CACHE_SERVICE_URL = originalUrl;
      if (originalTimeout) process.env.CACHE_SERVICE_TIMEOUT = originalTimeout;
      if (originalMaxEntries) process.env.CACHE_FALLBACK_MAX_ENTRIES = originalMaxEntries;
    });
  ...
  describe('Happy Path - Cache Operations', () => {
    describe('set operation', () => {
      ...
      it('should validate key parameter', async () => {
        ...
        const result2 = await client.set(null as any, { data: 'test' });
        const result3 = await client.set(undefined as any, { data: 'test' });
    ...
    describe('get operation', () => {
      it('should successfully get cache entry', async () => {
        ...
        server.use(
          http.get(`${baseUrl}/cache/get/test-key`, () => {
            return HttpResponse.json({
              key: 'test-key',
              value: testValue,
              found: true
      ...
      it('should return null for non-existent key', async () => {
        server.use(
          http.get(`${baseUrl}/cache/get/non-existent`, () => {
            return HttpResponse.json({
              key: 'non-existent',
              found: false,
      ...
      it('should handle URL encoding for special characters', async () => {
        ...
        server.use(
          http.get(`${baseUrl}/cache/get/${encodedKey}`, () => {
            return HttpResponse.json({
              key: specialKey,
      ...
      it('should validate key parameter', async () => {
        ...
        const result2 = await client.get(null as any);
        const result3 = await client.get(undefined as any);
    ...
    describe('mget operation', () => {
      ...
      it('should filter out invalid keys', async () => {
        const keys = ['valid-key', '', null as any, undefined as any, 'another-valid-key'];
      ...
      it('should validate keys parameter', async () => {
        const result1 = await client.mget(null as any);
        const result2 = await client.mget(undefined as any);
        const result3 = await client.mget('not-an-array' as any);
    ...
    describe('delete operation', () => {
      it('should successfully delete cache entry', async () => {
        server.use(
          http.delete(`${baseUrl}/cache/delete/test-key`, () => {
            return HttpResponse.json({
              success: true,
              key: 'test-key',
      ...
      it('should handle deletion of non-existent key', async () => {
        server.use(
          http.delete(`${baseUrl}/cache/delete/non-existent`, () => {
            return HttpResponse.json({
              success: false,
              key: 'non-existent',
      ...
      it('should validate key parameter', async () => {
        ...
        const result2 = await client.delete(null as any);
        const result3 = await client.delete(undefined as any);
    ...
    describe('invalidateByTag operation', () => {
      ...
      it('should handle tag with no matching entries', async () => {
        server.use(
          http.post(`${baseUrl}/cache/invalidate/tag`, () => {
            return HttpResponse.json({
      ...
      it('should validate tag parameter', async () => {
        ...
        const result2 = await client.invalidateByTag(null as any);
        const result3 = await client.invalidateByTag(undefined as any);
    ...
    describe('getStats operation', () => {
      ...
      it('should include fallback cache stats', async () => {
        ...
        server.use(
          http.get(`${baseUrl}/cache/stats`, () => {
            return HttpResponse.json({ keyCount: 10 });
          })
        );
  ...
  describe('Fallback Mechanisms', () => {
    ...
    describe('Timeout Handling', () => {
      it('should timeout and fall back after configured timeout', async () => {
        ...
        CacheServiceClient['instance'] = undefined as any;
        const timeoutClient = CacheServiceClient.getInstance();
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    describe('Concurrent Operations', () => {
      it('should handle concurrent set operations', async () => {
        ...
        const promises = Array.from({ length: 10 }, (_, i) =>
          client.set(`concurrent-key-${i}`, { data: `value-${i}` })
        );
      ...
      it('should handle concurrent get operations during fallback', async () => {
        ...
        const promises = Array.from({ length: 10 }, () =>
          client.get('shared-key')
        );

        const results = await Promise.all(promises);
        expect(results.every(result => 
          result && result.data === 'shared-value'
        )).toBe(true);
      });
      ...
      it('should handle concurrent operations with mixed success/failure', async () => {
        ...
        const promises = Array.from({ length: 10 }, (_, i) =>
          client.set(`mixed-key-${i}`, { data: `value-${i}` })
        );
    ...
    describe('Memory Pressure', () => {
      ...
      it('should handle JSON parsing errors gracefully', async () => {
        ...
        (client['fallbackCache'].get('corrupt-key')!.value.circular as any).self = 
    ...
    describe('Service Partial Availability', () => {
      ...
      it('should handle intermittent service availability', async () => {
        ...
        server.use(
          http.get(`${baseUrl}/cache/get/intermittent-key`, () => {
            requestCount++;
  ...
  describe('Performance Testing', () => {
    describe('Operation Timing', () => {
      it('should complete get operations within performance threshold', async () => {
        server.use(
          http.get(`${baseUrl}/cache/get/perf-test`, () => {
            return HttpResponse.json({
              key: 'perf-test',
        ...
        const { result, duration } = await global.testUtils.measureTime(
          () => client.get('perf-test')
        );
      ...
      it('should complete set operations within performance threshold', async () => {
        ...
        const { result, duration } = await global.testUtils.measureTime(
          () => client.set('perf-test', { data: 'test-value' })
        );
      ...
      it('should complete delete operations within performance threshold', async () => {
        server.use(
          http.delete(`${baseUrl}/cache/delete/perf-test`, () => {
            return HttpResponse.json({ success: true });
          })
        );

        const { result, duration } = await global.testUtils.measureTime(
          () => client.delete('perf-test')
        );
    ...
    describe('Fallback Performance', () => {
      it('should have fast fallback cache access', async () => {
        ...
        server.use(
          http.get(`${baseUrl}/cache/get/fallback-perf-test`, () => {
            return HttpResponse.error();
          })
        );

        const { result, duration } = await global.testUtils.measureTime(
          () => client.get('fallback-perf-test')
        );
      ...
      it('should handle high-frequency fallback operations', async () => {
        ...
        const operations = global.testUtils.generateConcurrentOps(100, (i) => 
          client.set(`high-freq-${i}`, { data: `value-${i}` })
        );
  ...
  describe('Error Logging and Monitoring', () => {
    it('should log errors without throwing exceptions', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining('Cache service set failed, using fallback:'),
        expect.any(Error)
      );
    ...
    it('should maintain service resilience under error conditions', async () => {
      ...
      server.use(
        http.get(`${baseUrl}/cache/get/resilience-test`, () => {
