...
describe('CacheServiceClient - Edge Cases', () => {
    ...
    describe('Memory Management Edge Cases', () => {
        ...
        it('should handle very large keys', async () => {
            ...
            }), msw_1.http.get(`${baseUrl}/cache/get/${encodeURIComponent(largeKey)}`, () => {
    ...
    describe('Network Edge Cases', () => {
        it('should handle response with no content-type header', async () => {
            server.use(msw_1.http.get(`${baseUrl}/cache/get/no-content-type`, () => {
        ...
        it('should handle response with wrong content-type', async () => {
            server.use(msw_1.http.get(`${baseUrl}/cache/get/wrong-content-type`, () => {
        ...
        it('should handle empty response body', async () => {
            server.use(msw_1.http.get(`${baseUrl}/cache/get/empty-body`, () => {
                return new Response('', {
                    status: 200,
        ...
        it('should handle response with BOM (Byte Order Mark)', async () => {
            ...
            server.use(msw_1.http.get(`${baseUrl}/cache/get/bom-test`, () => {
    ...
    describe('Concurrency Edge Cases', () => {
        it('should handle rapid successive calls to same key', async () => {
            ...
            const promises = Array.from({ length: 10 }, (_, i) => client.set('rapid-key', { data: `value-${i}` }));
        ...
        it('should handle mixed operations on same key', async () => {
            server.use(msw_1.http.post(`${baseUrl}/cache/set`, () => {
                return msw_1.HttpResponse.json({ success: true });
            }), msw_1.http.get(`${baseUrl}/cache/get/mixed-key`, () => {
                return msw_1.HttpResponse.json({
                    key: 'mixed-key',
                    value: { data: 'test' },
                    found: true
                });
            }), msw_1.http.delete(`${baseUrl}/cache/delete/mixed-key`, () => {
                return msw_1.HttpResponse.json({ success: true });
            }));
        ...
        it('should handle fallback cache operations during concurrent access', async () => {
            ...
            server.use(msw_1.http.get(`${baseUrl}/cache/get/concurrent-key`, () => {
                return msw_1.HttpResponse.error();
            }));
            // Multiple concurrent reads from fallback
            const reads = Array.from({ length: 20 }, () => client.get('concurrent-key'));
            const results = await Promise.all(reads);
            expect(results.every(result => result && result.data === 'initial')).toBe(true);
        });
    });
    describe('Configuration Edge Cases', () => {
        it('should handle configuration changes during runtime', async () => {
            ...
            cache_service_client_1.CacheServiceClient['instance'] = undefined;
            const newClient = cache_service_client_1.CacheServiceClient.getInstance();
        ...
        it('should handle extreme timeout values', async () => {
            ...
            cache_service_client_1.CacheServiceClient['instance'] = undefined;
            const maxTimeoutClient = cache_service_client_1.CacheServiceClient.getInstance();
            ...
            cache_service_client_1.CacheServiceClient['instance'] = undefined;
            const minTimeoutClient = cache_service_client_1.CacheServiceClient.getInstance();
        ...
        it('should handle malformed environment variables gracefully', async () => {
            ...
            cache_service_client_1.CacheServiceClient['instance'] = undefined;
            const malformedClient = cache_service_client_1.CacheServiceClient.getInstance();
    ...
    describe('Cleanup Edge Cases', () => {
        ...
        it('should handle multiple shutdown calls', async () => {
            const shutdownClient = cache_service_client_1.CacheServiceClient.getInstance();
...
//# sourceMappingURL=cache-service-client-edge-cases.test.js.map