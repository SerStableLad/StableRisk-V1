...
describe('Cache Controller Performance Tests', () => {
    ...
    describe('Throughput Tests', () => {
        it('should handle high-frequency SET operations', async () => {
            ...
            const setPromises = Array.from({ length: operationCount }, (_, i) => (0, supertest_1.default)(app)
                .post('/cache/set')
                .send({
                key: `perf:set:${i}`,
        ...
        it('should handle high-frequency GET operations', async () => {
            ...
            const setupPromises = Array.from({ length: 100 }, (_, i) => (0, supertest_1.default)(app)
                .post('/cache/set')
                .send({
                key: `perf:get:${i}`,
            ...
            const getPromises = Array.from({ length: operationCount }, (_, i) => {
                ...
                return (0, supertest_1.default)(app).get(`/cache/get/perf%3Aget%3A${keyIndex}`);
            });
        ...
        it('should handle mixed operation workload', async () => {
            ...
            const operations = [
                // SET operations
                ...Array.from({ length: setCount }, (_, i) => (0, supertest_1.default)(app)
                    .post('/cache/set')
                    .send({
                    key: `mixed:set:${i}`,
                ...
                // GET operations
                ...Array.from({ length: getCount }, (_, i) => (0, supertest_1.default)(app).get(`/cache/get/mixed%3Akey%3A${i % 50}`)),
                // DELETE operations
                ...Array.from({ length: deleteCount }, (_, i) => (0, supertest_1.default)(app).delete(`/cache/delete/mixed%3Adel%3A${i}`))
            ];
    ...
    describe('Concurrent Load Tests', () => {
            ...
            const userSessions = Array.from({ length: concurrentUsers }, (_, userIndex) => {
                ...
                const userOperations = Array.from({ length: operationsPerUser }, (_, opIndex) => {
                    ...
                    switch (operationType) {
                        ...
                        default:
                            return (0, supertest_1.default)(app).get('/cache/stats');
                    }
                });
        ...
        it('should maintain performance under memory pressure', async () => {
            ...
            const startTime = Date.now();
            const operations = Array.from({ length: operationCount }, (_, i) => (0, supertest_1.default)(app)
                .post('/cache/set')
                .send({
...
//# sourceMappingURL=cache-controller.performance.test.js.map